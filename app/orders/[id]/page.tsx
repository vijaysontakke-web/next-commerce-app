  ...
  return (
    <div className="container py-8 md:py-12 max-w-3xl">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Badge
          variant={order.status === "Processing" ? "secondary" : "default"}
        >
          {order.status}
        </Badge>
      </div>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="space-y-6 mt-4 relative pl-4 border-l-2 border-muted">
                {[
                  ...
                  const currentStatusIndex = stepOrder.indexOf(
                    order.status === "placed" ? "placed" : order.status
                  );
                  const isActive =
                    index <=
                  ...
                  const isCompleted =
                    index === 0 || steps.indexOf(order.status) >= index - 1;

                  const statusDate = order.statusDates?.[step.key];
