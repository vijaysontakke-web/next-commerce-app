...
export default function OrdersPage() {
  ...
  return (
    <div className="container py-8 md:py-12">
      ...
      <p className="text-muted-foreground mb-8">View your past orders and status.</p>
      ...
      {orders.length === 0 ? (
        ...
        <div className="grid gap-4">
           {orders.map((order) => (
             <Card key={order.id} className="hover:bg-muted/10 transition-colors">
                   ...
                   <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-4">
                         <span className="font-bold">
                            {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'INR' }).format(order.total)}
                         </span>
