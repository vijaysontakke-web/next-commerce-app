    ...
    <div className="flex flex-col gap-12">
      ...
      <section className="relative bg-muted py-12 md:py-20">
        <div className="container flex flex-col items-center text-center gap-6">
          ...
          <p className="max-w-[700px] text-lg text-muted-foreground md:text-xl">
             Explore our curated collection of electronics, fashion, and lifestyle products. 
      ...
      <section className="container py-8 md:py-12">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/products" className="hidden md:block text-primary hover:underline font-medium">
             View All Products
          </Link>
        </div>
